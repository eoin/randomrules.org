...
export class Vector4 {
  ...
  addScaled(vector4: Vector4, scalar: number): this {
  ...
  distanceToSquared(vector4: Vector4): number {
  ...
  multiplyByMatrix4(matrix4: Matrix4): Vector4 {
    var x = this.x,
      y = this.y,
      z = this.z,
      w = this.w,
  ...
  avoid(target: Vector4, acc: Vector4, strength: number): void {
