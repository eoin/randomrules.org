...
export class Matrix4 {
  ...
  setPosition(vector4: Vector4): this {
  ...
  multiplyByMatrix4(matrix4: Matrix4): Matrix4 {
    var a = this.elements,
      b = matrix4.elements;
    return new Matrix4([
  ...
  static createPerspective(fov: number, aspect: number, near: number, far: number): Matrix4 {
